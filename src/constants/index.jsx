export const features = [
  {
    ...
    caption: "Seamless Layering",
    title: "Unified Interface",
    text: "Stratify creates a single pane of glass for all your business applications, eliminating context switching.",
    button: {
  ...
  },
  {
    ...
    text: "Our layered security model ensures your data remains protected across every integration point.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "How easy is it to setup Stratify?",
    answer:
      "Stratify offers one-click deployment with our AI setup wizard. You'll be creating workflows in under 5 minutes with our guided onboarding process.",
  },
  {
    id: "1",
    question: "Can I integrate Stratify with other platforms?",
    answer:
      "Yes! Stratify connects seamlessly with 100+ platforms including Zapier, Slack, and Google Workspace through our API and pre-built connectors.",
  },
  {
    id: "2",
    question: "How often do you add new AI features?",
    answer:
      "We deploy new AI models and workflow templates weekly. All Pro and Enterprise plans receive automatic updates with new capabilities.",
  },
  {
    id: "3",
    question: "What's your refund policy?",
    answer:
      "We offer a 30-day money-back guarantee for all annual subscriptions. Monthly plans can be canceled anytime with no long-term commitment.",
  },
  {
    id: "4",
    question: "Do you have corporate plans?",
    answer:
      "Our Enterprise plan includes dedicated AI training, SSO, and custom workflow development for teams of 50+ users.",
  },
  {
    id: "5",
    question: "Can I upgrade my plan?",
    answer:
      "Yes! Upgrades take effect immediately with prorated pricing. Downgrades apply at your next billing cycle.",
  },
  {
    id: "6",
    question: "How do I invite my team?",
    answer:
      "Use our Team Portal to send role-based invitations (Admin, Editor, Viewer). All members get access to shared workflows and AI models.",
  },
  {
    id: "7",
    question: "Do you offer training?",
    answer:
      "We provide free weekly webinars and premium 1:1 AI workflow training. Enterprise customers get custom onboarding sessions.",
  },
  {
    id: "8",
    question: "I'm locked out of my account - what do I do?",
    answer:
      "Visit our 24/7 recovery portal at support.stratify.ai/lockout. Most issues are resolved automatically within 15 minutes.",
  },
];
...
export const plans = [
  {
    ...
    features: [
      "100 AI workflow executions/month",
      "50+ pre-built AI templates",
  ...
  },
  {
    ...
    priceMonthly: 79,
    priceYearly: 59,
    caption: "For scaling AI workflows",
    features: [
      "1,000 AI workflow executions/month",
...
export const testimonials = [
  {
    ...
    comment:
      "Stratify's customer support is second to none! They’re like my tech superheroes, always there when I need them.",
  },
  {
    id: "1",
    name: "Mark Erixon",
  ...
  },
  {
    ...
    comment:
      "Switched to Stratify last month, and I'm already seeing results. Best decision for our team!",
  },
  {
    id: "5",
    name: "Jim Bradley",
